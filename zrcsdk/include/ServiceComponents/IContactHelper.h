...
struct Contact
{
    ...
    uint32_t         signatureStartTimestamp = 0;              ///<Signature start UTC timestamp in seconds. 0 indicates no start time.
    uint32_t         signatureEndTimestamp = 0;                ///<Signature end UTC timestamp in seconds. 0 indicates no end time.

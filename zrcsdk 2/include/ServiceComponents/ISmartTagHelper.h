...
public:
     ...
     * @param isEditable TRUE indicates that smart tag is editable. Otherwise not.
     *
     * @changelog
     *  - 7.0.0: Added the isEditable parameter to indicate whether smart tag editing is allowed.
     */
    virtual void OnSmartTagStatusUpdated(SmartTagType type, bool enabled, bool isSupported, bool isEditable) = 0;
